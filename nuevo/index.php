    ...
    <div id="contenido" class="fade-in">
        <div class="container mt-5">
            <div class="row text-center">
                ...
                <ul>
                    <li id="d2">bebidas, snacks salados, galletas y crackers, avena, nueces y semillas</li>
                </ul>
                ...
                <div class="col-12 col-md-4 px-4 p-md-4">
                    <p class="justificar">En esta sección usted puede elegir la cantidad de productos que quiere añadir a su voluntad.</p>
                ...
                <div class="col-12 col-md-8 px-4 pb-2 p-md-4">
                    <form method="post" class="custom-form">
                        <div class="mb-3">
                            <label for="codigo" class="form-label collapsible-label">Id de tu producto:</label>
                            <input type="text" class="form-control collapsible-input" id="codigo" placeholder="Ej. A01" name="codigo" required autofocus>
                        </div>
                        <div class="mb-3">
                            <label for="producto" class="form-label collapsible-label">Nombre de producto:</label>
                            <input type="text" class="form-control collapsible-input" id="producto" placeholder="Producto..." name="producto" required>
                        </div>
                        <div class="mb-3">
                            <label for="precio" class="form-label collapsible-label">Precio c/u:</label>
                            <input type="number" class="form-control collapsible-input" id="precio" placeholder="Precio por unidad..." name="precio" required>
                        </div>
                        <div class="mb-3">
                            <label for="bodega" class="form-label collapsible-label">Cantidad que quiere adquirir:</label>
                            <input type="number" class="form-control collapsible-input" id="bodega" placeholder="Cantidad adquirida" name="bodega" required>
                        </div>
                        <div class="mb-3">
                            <?php include("nuevo_producto.php"); ?>
                        </div>
                        <div class="mb-3">
                            <input type="submit" class="btn btn-primary form-control mt-3" value="Agregar producto" name="agregar">
                        </div>
                    </form>
                </div>
            </div>
