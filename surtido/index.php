...
<body>
    ...
    <div id="contenido" class="fade-in">
        <div class="container mt-5">
            <div class="row text-center">
                <h1 class="py-3">Adquirir más producto</h1>
                <?php
                $showTable = isset($_GET['show']) && $_GET['show'] == 'true';
                ?>
                <div class="col-12 col-md-4 px-4 p-md-4">
                    <p class="justificar">Aquí puedes añadir más productos a tu gusto personal.</p>
                ...
                <div class="col-12 col-md-8 px-4 pb-2 p-md-4">
                    <form method="post" class="custom-form">
                        <div class="mb-3">
                            <label for="codigo" class="form-label collapsible-label">Código de producto:</label>
                            <input type="text" class="form-control collapsible-input" id="codigo" placeholder="Ej. A01" name="codigo" required autofocus>
                        </div>
                        <div class="mb-3">
                            <input type="submit" class="btn btn-primary form-control mt-3" value="Buscar producto" name="buscar">
                        </div>
                    </form>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <form method="post" class="custom-form">
                                <div class="mb-3">
                                    <label for="Surtido" class="form-label collapsible-label">Agregar a bodega las siguientes unidades:</label>
                                    <input type="number" class="form-control collapsible-input" id="Surtido" placeholder="Ej. 10" name="Surtido" required>
                                </div>
                                <div class="mb-3">
                                    <input type="submit" class="btn btn-primary form-control mt-3" value="Agregar a bodega" name="Agregar">
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div class="col">
                    <a href="../material/Ayuda.mp4">Ayuda</a>
                </div>
                <div class="col">
                    <a href="#inicio"><img src="../material/Logo.png" alt="Logo" width="80"></a>
                </div>
                <div class="col">
                    <a href="../material/Ayuda.mp4">Más Información</a>
                </div>
            </div>
        </div>
    </div>
